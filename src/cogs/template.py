...
class Example(Cog):
    ...
    async def cog_unload(self) -> None:
        ...
        self.bot.tree.remove_command(
            self.message_context_menu.name, type=self.message_context_menu.type
        )
        self.bot.tree.remove_command(
            self.user_context_menu.name, type=self.user_context_menu.type
        )
    ...
    async def message_context_menu_callback(
    ...
    async def user_context_menu_callback(
